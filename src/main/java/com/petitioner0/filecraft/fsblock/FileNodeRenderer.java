...
public class FileNodeRenderer implements BlockEntityRenderer<FileNodeBlockEntity> {
    ...
    private static final int   VIEW_DISTANCE = 8;     // 引擎裁剪半径（方块）
    private static final float PUSH_OUT     = 0.7f; // 从方块中心沿朝向法线外推的距离
    ...
    private static final int BG_COLOR   = 0x88000000;  // 半透明黑
    ...
    public void render(
            ...
            int light,
            int overlay,
            @Nonnull net.minecraft.world.phys.Vec3 cameraPos
    ) {
        ...
        pose.translate(nx * PUSH_OUT, ny * PUSH_OUT, nz * PUSH_OUT); 
